MRG's super decked out version: [![Build Status](http://mrg-beast.csail.mit.edu:8080/buildStatus/icon?job=dynamic-slam%2Fmaster)](http://mrg-beast.csail.mit.edu:8080/job/dynamic-slam/job/master/)
